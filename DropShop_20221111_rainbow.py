...
def build_course() -> Path:
    ...
    lst_of_segments = [Straight((85, 50), (500, 70), (-1, 0)),  Curve((45, 50), (85, 110), (-1, 1)), Straight((45, 110), (60, 160), (0, 1)),
                       Curve((45, 160), (100, 205), (1, 1)), Straight((100, 180), (600, 205), (1, 0)),  Curve((600, 180), (640, 220), (1, 1)),
                       Straight((620, 220), (640, 300), (0, 1)), Curve((600, 300), (640, 340), (-1, 1)), Straight((0, 320), (600, 340), (-1, 0))]
    
    lst_of_sme = [None, ((85, 60), (60, 80), (50, 110)), None, ((50, 160), (70, 190), (100, 195)), None, ((600, 193), (620, 200), (630, 220)), None, ((630, 300), (620, 322), (600, 330)), None]
...
def where_droplets_should_start(frame) -> None:
    ...
    cv2.rectangle(frame, (475, 55), (485, 65), (255, 0, 0), 2) #Droplet 1, 4, 5, 6
    cv2.rectangle(frame, (335, 55), (345, 65), (255, 0, 0), 2) #Droplet 2, 3
    cv2.rectangle(frame, (475, 190), (485, 200), (255, 0, 0), 2) 
    cv2.rectangle(frame, (335, 190), (345, 200), (255, 0, 0), 2)
...
if __name__ == '__main__':
    ...
    main("runs/detect/train10/weights/best.pt", "droplet_videos/20221111_rainbow2_notracking.mp4")
